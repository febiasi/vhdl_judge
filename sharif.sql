...
CREATE TABLE `shj_problems` (
  ...
  `vhdl_time_limit` int(11) NOT NULL DEFAULT '3000',
...
INSERT INTO `shj_problems` VALUES (1,1,'Problem ',100,0,500,1500,2000,3000,50000,'C,C++,Python 2,Python 3,Java','diff','-bB'),(4,1,'7400',100,0,500,1500,2000,4000,50000,'VHDL','diff','-bB');
...
INSERT INTO `shj_submissions` VALUES (3,'balbertini',1,1,0,'2015-08-27 00:20:58','SCORE',10000,'100','1-3','1','c'),(4,'balbertini',1,1,1,'2015-08-27 00:24:16','SCORE',10000,'100','1-4','1','cpp'),(1,'balbertini',4,1,0,'2015-10-26 20:59:26','SCORE',10000,'100','pcs7400-1','pcs7400','vhdl'),(2,'balbertini',4,1,1,'2015-11-11 21:48:52','SCORE',5000,'100','pcs7400-2','pcs7400','vhdl');
...
-- Dump completed on 2015-11-16 17:05:57
